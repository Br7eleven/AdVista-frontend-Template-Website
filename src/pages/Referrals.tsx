...
export default function Referrals() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-light">Referral Program</h1>
      ...
      <div className="bg-white dark:bg-dark-600 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-dark-500 text-gray-900 dark:text-light">
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <div className="flex-1 w-full">
            <div className="relative">
              <input
                ...
                value={referralLink}
                readOnly
                className="w-full px-4 py-2 border border-gray-200 dark:border-dark-400 rounded-lg focus:ring-primary-500 focus:border-primary-500 bg-gray-50 dark:bg-dark-700 text-gray-900 dark:text-light transition-colors"
              />
            </div>
          </div>
          ...
          <div className="flex space-x-2 w-full sm:w-auto">
            <button
              ...
              className="flex-1 px-4 py-2 bg-gray-100 dark:bg-dark-700 rounded-lg hover:bg-gray-200 dark:hover:bg-dark-800 transition flex items-center justify-center text-gray-900 dark:text-light"
            >
            ...
            <a
              ...
              className="flex-1 px-4 py-2 bg-secondary-600 text-white rounded-lg hover:bg-secondary-700 transition flex items-center justify-center"
            >
        ...
        <div className="mt-4 p-4 bg-gray-50 dark:bg-dark-700 rounded-lg text-gray-900 dark:text-light">
          <div className="flex justify-between items-center">
            <div>
              <p className="text-sm font-medium text-primary-600 dark:text-accent-300">Your Referral Code</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-light">{referralCode}</p>
            </div>
            <div className="text-right">
              <p className="text-sm font-medium text-primary-600 dark:text-accent-300">Total Earnings</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-dark-600 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-dark-500 text-gray-900 dark:text-light">
          ...
          <div className="text-3xl font-bold mb-2">{referralStats.totalReferrals || 0}</div>
        ...
        <div className="bg-white dark:bg-dark-600 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-dark-500 text-gray-900 dark:text-light">
          ...
          <div className="text-3xl font-bold mb-2">${referralStats.totalEarnings?.toFixed(2) || '0.00'}</div>
        ...
        <div className="bg-white dark:bg-dark-600 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-dark-500 text-gray-900 dark:text-light">
          ...
          <div className="text-3xl font-bold mb-2">{referralStats.activeReferrals || 0}</div>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-dark-500">
              ...
              <tbody className="bg-white dark:bg-dark-600 divide-y divide-gray-100 dark:divide-dark-500">
                {referrals.map((referral) => (
                  <tr key={referral.id} className="text-gray-900 dark:text-light">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-secondary-600 dark:text-secondary-400 text-right">
      ...
      <div className="bg-white dark:bg-dark-600 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-dark-500 text-gray-900 dark:text-light">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            <div className="bg-primary-50 dark:bg-accent-900/30 p-2 rounded-full h-8 w-8 flex items-center justify-center">
              <span className="font-semibold text-primary-600 dark:text-accent-300">1</span>
            </div>
            <div>
          ...
          <div className="flex items-start space-x-3">
            <div className="bg-primary-50 dark:bg-accent-900/30 p-2 rounded-full h-8 w-8 flex items-center justify-center">
              <span className="font-semibold text-primary-600 dark:text-accent-300">2</span>
            </div>
            <div>
          ...
          <div className="flex items-start space-x-3">
            <div className="bg-primary-50 dark:bg-accent-900/30 p-2 rounded-full h-8 w-8 flex items-center justify-center">
              <span className="font-semibold text-primary-600 dark:text-accent-300">3</span>
            </div>
            <div>
